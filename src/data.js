...
export const CHAIN = ['consult_scheduled', 'consult_done', 'kt', 'plan_wait', 'plan', 'treatment', 'done']

// Roles (mirror of server/config.js). `stages: null` = every column.
...
export const STAGES = [
  ...
  { id: 'plan_wait',         title: 'Очікує план лікування',   color: '#0284c7', tint: '#e0f2fe', norm: '48 год' },
  { id: 'plan',              title: 'План лікування складено', color: '#0d9488', tint: '#e7fbf5', norm: '' },
